...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 08, 2025 at 05:35 PM
...
INSERT INTO `attendance` (`date`, `id`, `absent`, `late`, `present`, `sid`) VALUES
('2025-01-08', 1, NULL, NULL, 'p', '446'),
('2025-01-08', 2, NULL, NULL, 'p', '440'),
('2025-01-08', 3, NULL, NULL, 'p', '443'),
('2025-01-08', 4, NULL, NULL, 'p', '439'),
('2025-01-08', 5, NULL, NULL, 'p', '441'),
('2025-01-08', 6, NULL, NULL, 'p', '445'),
('2025-01-08', 7, NULL, NULL, 'p', '444'),
('2025-01-08', 8, NULL, NULL, 'p', '1'),
('2025-01-08', 9, NULL, NULL, 'p', '447'),
('2025-01-08', 10, NULL, NULL, 'p', '448'),
('2025-01-08', 11, NULL, NULL, 'p', '442');
...
INSERT INTO `departments` (`id`, `department_id`, `department_name`, `head_of_department`, `start_date`) VALUES
(1, 'SCI101', 'Science', 'Bishal Neupane ', '2015-01-01'),
(2, 'ENG001', 'English', 'Dasarath Rai', '2015-01-01'),
(3, 'NEP010', 'Nepali', 'Nirmala Sharma', '2016-01-01'),
(4, 'MAT210', 'Maths', 'Bashu Dev Pokheral', '2016-01-01'),
(5, 'SOC301', 'Social', 'Bhupal Acharya', '2016-01-01'),
(6, 'HPC501', 'HPCA', 'Indira Chhetri', '2009-01-01'),
(7, 'COM550', 'Computer Science', 'Som Kumar Lama', '2015-01-01'),
(8, 'ACC700', 'Accountancy', 'Sachin Adhikari', '2015-01-01'),
(10, 'MKS221', 'MKS', 'Mithlesh Singh', '2024-01-01');
...
(11, 14, NULL, '$2a$10$mncA03DC5.tLrfRgjoKOZedaiqNa7sU4D1EUTVhmN3jQb9uG1l6BG', 'ADMIN', '14', 'sadhana'),
(12, 15, NULL, '$2a$10$G/.twTT7iroh/yOQuPIQLOgkBiZHIeSrINEnOpqoqbNBmvw9iYtnC', 'TEACHER', '15', 'subin'),
(13, 16, NULL, '$2a$10$e3q5AOUMBuxYbT9DQxSihO4/V3JSqgupCYGOSpTM1aQjhMQCajBQ6', 'TEACHER', '16', 'surohan'),
(14, 17, NULL, '$2a$10$PYexRFrlAeaELllzzlwEVOXV/cteWm3F0Ri0CoqjkA6H3LdQ9alvy', 'TEACHER', '17', 'wonjala'),
(15, 18, NULL, '$2a$10$KBM41vInhSZTb.WclGMMOeMsNRan.T4LmbExF1Yp1qIwC.uA/nz0G', 'TEACHER', '18', 'swsoti');
...
INSERT INTO `marks` (`english`, `math`, `nepali`, `opt_accountancy`, `opt_computer`, `opt_english`, `opt_math`, `opt_science`, `science`, `social`, `student_id`, `year`, `id`, `term`) VALUES
(NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2081, 1, 'first_term_examination_th'),
(85.5, 92, 78, 85, 83, 89, 76, 84.5, 88.5, 82, 1, 2025, 2, 'First Term Examination_th'),
(NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 2081, 3, 'first_term_examination_th'),
(85.5, 92, 78, 85, 83, 89, 76, 84.5, 88.5, 82, 123, 2025, 4, 'First');
...
(1, 'Block J', '10th Grade', '2001-05-07', 'ADMIN', 'singhmithlesh095@gmail.com', 'Mithlesh Kumar Singh', 'mks.png', 'Sarlahi', '9742528656', 'STF001', 'A_PLUS', 'MALE'),
(13, '10', '10', '2222-01-01', 'Nepali', 'singhmithlesh095@gmail.com', 'Amit Kumar Singh', '', 'lalitpur', '9817622227', 'STD013', 'A_PLUS', 'MALE'),
(14, '', '10', '2002-09-04', 'English Department', 'mandeyra7@gmail.com', 'Sadhana Sapkota', 'sadhana.jpg', 'Goldhunga', '9818280183', 'STF003', 'A_PLUS', 'FEMALE'),
(15, '', '10 A', '2001-01-01', 'Computer Department', 'subinsedhai002@gmail.com', 'Subin Sedhai', 'subin.jpg', 'Baneshwor', '9876543210', 'STF004', 'B_MINUS', 'MALE'),
(16, '', '10 B', '2001-01-01', 'Accountancy Department', 'surohan@gmail.com', 'Surohan Maharjan', 'surohan.jpg', 'Lalitpur', '9877654321', 'STF005', 'O_PLUS', 'MALE'),
(17, '', '10 C', '2001-01-01', 'Social Department', 'wonjala@gmail.com', 'Wonjala Joshi', 'wonjala.jpg', 'Lalitpur', '9877654321', 'STF006', 'O_PLUS', 'FEMALE'),
(18, 'Block M', '12th Grade', '2059-06-06', 'Nepali Department', 'swostikamagar098@gmail.com', 'Swastika Thapa', '', 'Manbhawan', '9822452661', 'STF020', 'A_PLUS', 'FEMALE');
...
(1, 'B+', '2001-05-07T00:00:00.000Z', 'singhmithlesh095@gmail.com', 'Mithlesh Kumar Singh', 'Male', 'mks.png', 'Lalitpur', NULL, 'Ram Krishna Singh', '9817622227', 'Others', '1', 'A', '10'),
...
(498, 'B+', '2001-05-07T00:00:00.000Z', 'singhmithlesh095@gmail.com', 'Mithlesh Kumar Singh', 'Male', NULL, 'Lalitpur', NULL, 'Ram Krishna Singh', '9867028164', 'Hindu', '13', 'E', '10');
...
INSERT INTO `student_marks` (`id`, `marks`, `subject`, `term`, `year`, `student_account_id`) VALUES
(1, 55, 'Science', 'first_term_examination_th', '2081', 1),
(2, 55, 'Science', 'first_term_examination_th', '2081', 439),
(3, 55, 'Science', 'first_term_examination_th', '2081', 440),
(4, 55, 'Science', 'first_term_examination_th', '2081', 441),
(5, 55, 'Science', 'first_term_examination_th', '2081', 442),
(6, 55, 'Science', 'first_term_examination_th', '2081', 443),
(7, 55, 'Science', 'first_term_examination_th', '2081', 444),
(8, 55, 'Science', 'first_term_examination_th', '2081', 445),
(9, 55, 'Science', 'first_term_examination_th', '2081', 446),
(10, 55, 'Science', 'first_term_examination_th', '2081', 447),
(11, 55, 'Science', 'first_term_examination_th', '2081', 448),
(12, 33, 'Math', 'first_term_examination_th', '2081', 1),
(13, 33, 'Math', 'first_term_examination_th', '2081', 439),
(14, 33, 'Math', 'first_term_examination_th', '2081', 440),
(15, 33, 'Math', 'first_term_examination_th', '2081', 441),
(16, 33, 'Math', 'first_term_examination_th', '2081', 442),
(17, 33, 'Math', 'first_term_examination_th', '2081', 443),
(18, 33, 'Math', 'first_term_examination_th', '2081', 444),
(19, 33, 'Math', 'first_term_examination_th', '2081', 445),
(20, 33, 'Math', 'first_term_examination_th', '2081', 446),
(21, 33, 'Math', 'first_term_examination_th', '2081', 447),
(22, 33, 'Math', 'first_term_examination_th', '2081', 448),
(23, 11, 'Science', 'first_term_examination_pr', '2081', 1),
(24, 11, 'Science', 'first_term_examination_pr', '2081', 439),
(25, 11, 'Science', 'first_term_examination_pr', '2081', 440),
(26, 11, 'Science', 'first_term_examination_pr', '2081', 441),
(27, 1, 'Science', 'first_term_examination_pr', '2081', 442),
(28, 11, 'Science', 'first_term_examination_pr', '2081', 443),
(29, 1, 'Science', 'first_term_examination_pr', '2081', 444),
(30, 10, 'Science', 'first_term_examination_pr', '2081', 445),
(31, 1, 'Science', 'first_term_examination_pr', '2081', 446),
(32, 11, 'Science', 'first_term_examination_pr', '2081', 447),
(33, 11, 'Science', 'first_term_examination_pr', '2081', 448),
(34, 24, 'Computer', 'first_term_examination_th', '2081', 1),
(35, 24, 'Computer', 'first_term_examination_th', '2081', 439),
(36, 0, 'Computer', 'first_term_examination_th', '2081', 440),
(37, 0, 'Computer', 'first_term_examination_th', '2081', 441),
(38, 0, 'Computer', 'first_term_examination_th', '2081', 442),
(39, 0, 'Computer', 'first_term_examination_th', '2081', 443),
(40, 0, 'Computer', 'first_term_examination_th', '2081', 444),
(41, 0, 'Computer', 'first_term_examination_th', '2081', 445),
(42, 0, 'Computer', 'first_term_examination_th', '2081', 446),
(43, 0, 'Computer', 'first_term_examination_th', '2081', 447),
(44, 0, 'Computer', 'first_term_examination_th', '2081', 448);
...
INSERT INTO `subject` (`id`, `subject_class`, `subject_id`, `subject_name`) VALUES
(1, '1', 'ENG101', 'English'),
(3, '1p0', 'nks', 'mks');
...
ALTER TABLE `departments`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `UK7dnvmpxfg50jax4a9nhgte4o4` (`department_id`);
...
ALTER TABLE `student_marks`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK64jl73y6b5xh60m37f4jblr09` (`student_account_id`);
...
--
ALTER TABLE `student_marks`
  ADD CONSTRAINT `FK64jl73y6b5xh60m37f4jblr09` FOREIGN KEY (`student_account_id`) REFERENCES `students_detail` (`account_id`);
COMMIT;
