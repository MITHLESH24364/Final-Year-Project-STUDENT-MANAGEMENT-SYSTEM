...
// //             <h5 className="modal-title">{currentStudent.fullname}Student's Details</h5>
// //             <button
// //               type="button"
// //               className="btn-close"
// //               onClick={onClose}
...
// //               }}
// //             />
// //             <p><strong>ID:</strong> {currentStudent.accountId}</p>
// //             <p><strong>Name:</strong> {currentStudent.fullname}</p>
// //             <p><strong>Class:</strong> {currentStudent.class}</p>
// //             <p><strong>Section:</strong> {currentStudent.number}</p>
// //             <p><strong>Roll No:</strong> {currentStudent.rollNo}</p>
// //             <p><strong>Father's Phone:</strong> {currentStudent.fatherPhone}</p>
// //             <p><strong>Mother's Phone:</strong> {currentStudent.motherPhone}</p>
// //           </div>
...
//               {currentStudent.fullname} - Student's Details
//             </h5>
//             <button
//               type="button"
//               className="btn-close"
...
//             </p>
//             <p>
//               <strong>Section:</strong> {currentStudent.number}
//             </p>
//             <p>
//               <strong>Roll No:</strong> {currentStudent.rollNo}
//             </p>
//             <p>
