...
//   const data = [
//     { id: 1, name: 'Aarzoo Maharjan', roll: 'IMS-25124', attendance: ['P', 'P', 'N', 'H', 'P', 'N', 'P', 'P', 'P', 'N'] },
//     { id: 2, name: 'Anjina Maharjan', roll: 'IMS-24742', attendance: ['P', 'P', 'N', 'H', 'P', 'N', 'P', 'P', 'P', 'N'] },
//     { id: 3, name: 'Cyrus Raj Bajracharya', roll: 'IMS-25232', attendance: ['P', 'P', 'N', 'H', 'P', 'N', 'P', 'P', 'P', 'N'] },
//     { id: 1, name: 'Aarzoo Maharjan', roll: 'IMS-25124', attendance: ['P', 'P', 'N', 'H', 'P', 'N', 'P', 'P', 'P', 'N'] },
//     { id: 2, name: 'Anjina Maharjan', roll: 'IMS-24742', attendance: ['P', 'P', 'N', 'H', 'P', 'N', 'P', 'P', 'P', 'N'] },
//     { id: 3, name: 'Cyrus Raj Bajracharya', roll: 'IMS-25232', attendance: ['P', 'P', 'N', 'H', 'P', 'N', 'P', 'P', 'P', 'N'] },
//     { id: 1, name: 'Aarzoo Maharjan', roll: 'IMS-25124', attendance: ['P', 'P', 'N', 'H', 'P', 'N', 'P', 'P', 'P', 'N'] },
...
//                       <td key={idx} className={getAttendanceClass(student.attendance[idx] || '')}>
//                         {student.attendance[idx] || ''}
//                       </td>
//                     ))}
//                   </tr>
//                 ))}
